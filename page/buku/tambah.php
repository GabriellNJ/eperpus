...
if(isset($_POST['tambah'])) {
	...
	$sql = $conn->query("INSERT INTO tb_buku VALUES (null,'$foto', '$judul','$kategori', '$pengarang', '$penerbit', '$tahun_terbit', '$isbn', '$jumlah', '$lokasi', '$desk', '$tgl_input')") or die(mysqli_error($conn));
	if($sql) {
...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        <label class="small mb-1" for="judul_buku">Foto </label>
        <input class="form-control" id="foto" name="foto" type="file" placeholder="Masukan foto buku"/>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        <label class="small mb-1" for="desk">Deskripsi</label>
        <input class="form-control" id="desk" name="desk" type="text" placeholder="Masukan Deskripsi buku"/>
    </div>
    <div class="form-group">
